...
class CreateUserFirstLastLikesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_first_last_likes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('user_first_last_likes');
    }
}
