...
class CreateUserMilestoneLikesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_milestone_likes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('user_milestone_likes');
    }
}
