...
class CreateUserWishListLikesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_wish_list_likes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('user_wish_list_likes');
    }
}
