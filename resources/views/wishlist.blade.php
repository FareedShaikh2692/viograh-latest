...
@section('pageContent')
    ...
    <div class="inner_wishlist_page  sectionbox sectionbottom30">
        ...
        <div class="title_btn_row">
            ...
            <div class="createnew">
                <a href="{{route('wishlist.add')}}" class="pink_btn addplus"> <span>  </span> Create New</a>
            </div>
        </div>
        ...
        @else
            <div class="appdata">
                <ul class="viograf_row js-load_more_button">
                    @include('include.wishlist-block')
                </ul>
            </div>
            @php
