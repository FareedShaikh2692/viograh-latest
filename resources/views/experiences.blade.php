    ...
    <div class="inner_diary_page  sectionbox sectionbottom30">
        ...
        <div class="title_btn_row">
            <div class="create_title">
                <h1 class="main_title">Experiences</h1>
            </div>
            <div class="createnew">
                <a href="{{route('experience.add')}}" class="pink_btn addplus"> <span>  </span> Create New</a>
            </div>
        </div>

        @if(count($experienceCount) == 0)
        ...
        @else
            <div class="appdata">
                ...
                @include('include.experience-block')
                </ul>
            </div>
            @php
