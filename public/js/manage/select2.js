   ...
   */
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        unselect: function (selected) {
            ...
            if(this.opts.allowRepetitionForMultipleSelect) {
                ...
                console.log(this.valWithDuplicate);
                console.log(data);
        ...
        processDuplicatedResults: function () {
            ...
            //if(itemIDs != ""){
                itemIDs = itemIDs != ''? itemIDs.slice(0,itemIDs.length - 1): '';
    ...
    $.fn.select2 = function () {
        ...
        var args = Array.prototype.slice.call(arguments, 0),
            ...
            allowedMethods = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "dropdown", "onSortStart", "onSortEnd", "enable", "disable", "readonly", "positionDropdown", "data", "search","customReset"],
